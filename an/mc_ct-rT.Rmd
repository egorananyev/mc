...
```{r}
m <- lmer(stat ~ tDelayStat + (1|subj), data=ss)
summary(m)
anova(m)
summary(lm(stat ~ tDelayStat, data=ss))
...
```{r}
m <- lmer(dyna ~ tDelayStat + (1|subj), data=ss)
summary(m)
anova(m)
summary(lm(dyna ~ tDelayStat, data=ss))
...
```{r}
m <- lmer(patchy ~ tDelayStat + (1|subj), data=ss)
summary(m)
anova(m)
summary(lm(patchy ~ tDelayStat, data=ss))
...
```{r}
m <- lmer(stat ~ tDelayDyna + (1|subj), data=ss)
summary(m)
anova(m)
summary(lm(stat ~ tDelayDyna, data=ss))
bfBase <- lmBF(stat ~ subj, data=ss, whichRandom = 'subj')
...
```{r}
m <- lmer(dyna ~ tDelayDyna + (1|subj), data=ss)
summary(m)
anova(m)
summary(lm(dyna ~ tDelayDyna, data=ss))
bfBase <- lmBF(dyna ~ subj, data=ss, whichRandom = 'subj')
...
```{r}
m <- lmer(patchy ~ tDelayDyna + (1|subj), data=ss)
summary(m)
anova(m)
summary(lm(patchy ~ tDelayDyna, data=ss))
bfBase <- lmBF(patchy ~ subj, data=ss, whichRandom = 'subj')
...
```{r}
ss <- ss[ss$resp=='static',]
summary(lmer(ring ~ tDelayStat + (1|subj), data=ss))
summary(lm(ring ~ tDelayStat, data=ss))
...
```{r}
ss <- ss[ss$resp=='static',]
summary(lmer(ring ~ tDelayDyna + (1|subj), data=ss))
summary(lm(ring ~ tDelayDyna, data=ss))
bfBase <- lmBF(ring ~ subj, data=ss, whichRandom = 'subj')
